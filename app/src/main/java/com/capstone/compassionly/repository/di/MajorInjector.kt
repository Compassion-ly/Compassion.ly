...
object MajorInjector {
    fun majorInjector(context: Context): CommonViewModelFactory {
        ...
        return CommonViewModelFactory(userRep, schoolRep, localDataSource!!, state, majorRep, topicRepository)
    }
}